...
const TeamSetup: React.FC<TeamSetupProps> = ({
  ...
  return (
    <div className="min-h-screen bg-gradient-primary flex items-center justify-center p-4">
      <Card className="w-full max-w-md bg-gradient-card shadow-card border-border/50 p-8">
        <button onClick={onBack} className="mb-4 text-base">← Back</button>

        <h2 className="text-lg font-bold mb-4">Select Number of Teams</h2>
        ...
        <button
         onClick={onReady}
          className="py-2 px-6 rounded bg-[#41A300] hover:bg-[#2F7500] text-white text-lg"
         >
         Ready!
       </button>
      </div>
